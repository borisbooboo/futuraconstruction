...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DlGq7lnC.mjs");
...
const manifest = {
  "2a8afe031ca75d25e2799e09b7326e92a1d0f1ac2c77ac16859754cda234eb21": {
    ...
    importer: () => import("./admin.functions-B8IqklGM.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CYmLkTqG.mjs").then((n) => n.r),
    import("./start-Kg0zUmhz.mjs"),
