...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-m2Qzi9Z1.mjs");
...
const manifest = {
  "2a8afe031ca75d25e2799e09b7326e92a1d0f1ac2c77ac16859754cda234eb21": {
    functionName: "createSubAdmin_createServerFn_handler",
    importer: () => import("./admin.functions-uC0ORsUb.mjs")
  },
  "86628a94b42888b5664ae10848c339ca06d4b41efae621120d5729f04d48a653": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CaVb9e73.mjs").then((n) => n.r),
    import("./start-CJgpSDJ8.mjs"),
